...
class NewsReaderModel {
	...
	/**
	 * if dummyData is false an instance of modelManager will be used to retrieve
	 * all available articles from the server
	 * 
	 */
	...
	void retrieveData() {
		...
		String[] abstractImage = { "file:./images/abstract1.jpg", "file:./images/abstract2.jpg",
				...
				null };
		Category[] category = { Category.SPORTS, Category.ECONOMY, Category.INTERNATIONAL, Category.ECONOMY };
	...
	private void dataFromServer() {
		try {
			List<Article> articlesList = connectionManager.getArticles();
