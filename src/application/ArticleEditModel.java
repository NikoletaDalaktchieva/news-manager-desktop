...
/**
 * This class is used to represent an article when it is editing This class is
 * needed to develop ArticleEditController
 * 
 * @author ÁngelLucas
 *
 */
class ArticleEditModel {
	...
	/**
	 * It is a flag used to indicate that exists updates for the article - False:
	 * unmodified - True: modified
	 */
	...
	/**
	 * Construct an ArticleModel instance with a new empty article that belong to
	 * user
	 * 
	...
	/**
	 * This method provide access to edited article abstract property. So, this
	 * abstract can be modified through this property
	 * 
	 * @return a StringPorperty of edited article abstract. The returned value is
	...
	/**
	 * This method adds a change listener to all article properties in order to know
	 * whenever there is a change on edited article
	 */
	private void addedChangeListener() {
		...
		/*
		 * this.edited.isPublishProperty().addListener( (observable, oldvalue, newvalue)
		 * ->this.bModified = true);
		 */
	...
	/**
	 * This method provide access to edited article body property. So, this body can
	 * be modified through this property
	 * 
	 * @return a StringPorperty of edited article body. The returned value is
	 *         suitable for binding
	 */
	...
	/**
	 * Consolidates changes permanently. Changes can't be undone Copy article data
	 * from the edited one to the original
	 */
	public void commit() {
		if (!this.bModified)
	...
	/**
	 * Discard all changes. Changes will be lost Copy article data from the original
	 * one to the edited
	 * 
	 */
	...
	Article getArticleOriginal() {
		return (this.original != null && this.original.getTitle() != null && !this.original.getTitle().equals(""))
				? this.original
				: null;
	}
	 ...
	 */
	/*
	 * boolean isPublic() { return edited.isPublish(); }
	 */

	/**
	 * @return a Property of edited article isPublic. The returned value is suitable
	 *         for binding
	 */
	/*
	 * public Property<Boolean> isPublicProperty() { return
	 * edited.isPublishProperty(); }
	 */
	...
	/**
	 * This method provide access to edited article subtitle property. So, this
	 * subtitle can be modified through this property
	 * 
	 * @return a StringPorperty of edited article title. The returned value is
	 *         suitable for binding
	 */
	...
	/**
	 * This method provide access to edited article title property. So, this title
	 * can be modified through this property
	 * 
	 * @return a StringPorperty of edited article title. The returned value is
	 *         suitable for binding
	 */
